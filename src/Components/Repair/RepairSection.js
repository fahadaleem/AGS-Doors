...
import { Typography, makeStyles, Grid, Box, Button, Container } from "@material-ui/core";
    ...
    <div>
      ...
      <Grid container className={classes.container}>
        ...
        <Typography variant="p" color="initial" display="block">
            ...
            jobs: going up and coming down. They really don’t have much
            character than that, do they? But neither does a body guard until
            you need their service, or if one isn’t around when you really need
            them to be. <br />
            <br />
            ...
            weather. It’s only when they stop doing their rather simple job (go
            up, come down!), that you realize how important the role really is.
            And how much you take for granted that they can go up and down with
            ...
            experts who are knowledgeable on exactly what you need, and can get
            the job done right. Garage doors and gates may be rather bland to
            anyone else, but it’s all that we do, all day, every day, here at
            ASG Doors and Gates.
          </Typography>
        </Box>
        <Box p={4}>
